...
public class Person implements Serializable{
	...
	ObjectOutputStream toServerPoker2 = null;
	DataOutputStream toServerNum = null;
	DataOutputStream gameOver = null;
	...
	class playPoker implements Runnable{
		...
		public void run() {
			...
			for(int i=0;i<8;i++) {
				removeIndex.add(in.nextInt());
				
			}
			mypokers.remove(removeIndex.get(7)-1);mypokers.remove(removeIndex.get(6)-1);mypokers.remove(removeIndex.get(5)-1);mypokers.remove(removeIndex.get(4)-1);
			mypokers.remove(removeIndex.get(3)-1);mypokers.remove(removeIndex.get(2)-1);mypokers.remove(removeIndex.get(1)-1);mypokers.remove(removeIndex.get(0)-1);
